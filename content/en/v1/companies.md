---
title: "Companies"
description: "Manage companies in Pact API v1"
section: "v1"
---

## Companies

> **Note:** Each user has many companies. Each user must have at least one company in the system.
...
> **Note:** If you want to receive `webhooks` make sure that `webhook_url` is present. Webhook url must be valid and response code on `POST` json-request `{'source':'pact.im', 'operation':'test'}` must be 200
